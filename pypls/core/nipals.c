...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "pypls.core.nipals",
        "sources": [
            "pypls\\core\\nipals.pyx"
        ]
    },
    "module_name": "pypls.core.nipals"
}
END: Cython Metadata */
...
#define __PYX_HAVE__pypls__core__nipals
#define __PYX_HAVE_API__pypls__core__nipals
/* Early includes */
#include <string.h>
#include <stdlib.h>
#include <math.h>
...
#define __Pyx_MODULE_NAME "pypls.core.nipals"
extern int __pyx_module_is_main_pypls__core__nipals;
int __pyx_module_is_main_pypls__core__nipals = 0;

/* Implementation of 'pypls.core.nipals' */
...
static const char __pyx_k_nipals[] = "nipals";
...
static const char __pyx_k_pypls_core_nipals[] = "pypls.core.nipals";
static const char __pyx_k_pyx_unpickle_Enum[] = "__pyx_unpickle_Enum";
static const char __pyx_k_cline_in_traceback[] = "cline_in_traceback";
static const char __pyx_k_strided_and_direct[] = "<strided and direct>";
static const char __pyx_k_strided_and_indirect[] = "<strided and indirect>";
static const char __pyx_k_contiguous_and_direct[] = "<contiguous and direct>";
static const char __pyx_k_pypls_core_nipals_pyx[] = "pypls\\core\\nipals.pyx";
...
static PyObject *__pyx_n_s_nipals;
...
static PyObject *__pyx_n_s_pypls_core_nipals;
static PyObject *__pyx_kp_s_pypls_core_nipals_pyx;
...
static PyObject *__pyx_pf_5pypls_4core_6nipals_nipals(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, __Pyx_memviewslice __pyx_v_y, double __pyx_v_tol, int __pyx_v_max_iter); /* proto */
...
static double __pyx_f_5pypls_4core_6nipals_nipals_c(__Pyx_memviewslice __pyx_v_x, __Pyx_memviewslice __pyx_v_y, double __pyx_v_tol, int __pyx_v_max_iter, __Pyx_memviewslice __pyx_v_w, __Pyx_memviewslice __pyx_v_t, __Pyx_memviewslice __pyx_v_u) {
  Py_ssize_t __pyx_v_i;
  Py_ssize_t __pyx_v_j;
  Py_ssize_t __pyx_v_n;
  Py_ssize_t __pyx_v_p;
  int __pyx_v_niter;
  double *__pyx_v_tmp_w;
  double __pyx_v_d;
  double __pyx_v_c;
  double __pyx_v_unorm;
  ...
  __Pyx_RefNannySetupContext("nipals_c", 0);

  /* "pypls/core/nipals.pyx":20
 *     cdef:
 *         Py_ssize_t i, j
 ...
 *         double c = 0.
 */
  __pyx_v_tmp_w = ((double *)calloc(__pyx_v_p, (sizeof(double))));

  /* "pypls/core/nipals.pyx":24
 *         int niter = 0
 *         double * tmp_w = <double *> calloc(p, sizeof(double))
 *         double d = tol * 10.             # <<<<<<<<<<<<<<
 *         double c = 0.
 ...
 */
  __pyx_v_d = (__pyx_v_tol * 10.);

  /* "pypls/core/nipals.pyx":25
 *         double * tmp_w = <double *> calloc(p, sizeof(double))
 *         double d = tol * 10.
 *         double c = 0.             # <<<<<<<<<<<<<<
 *         double unorm, wnorm, tnorm, tk, ck, uk, d1, d2
 ...
 */
    __pyx_t_4 = __pyx_v_i;
    __pyx_t_5 = __pyx_v_i;
    *((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_u.data) + __pyx_t_5)) )) = (*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_y.data) + __pyx_t_4)) )));
  }

  /* "pypls/core/nipals.pyx":31
 *         u[i] = y[i]
 * 
 *     while d > tol and niter <= max_iter:             # <<<<<<<<<<<<<<
 *         # w = X'u/u'u
 ...
 */
  while (1) {
    __pyx_t_7 = ((__pyx_v_d > __pyx_v_tol) != 0);
    if (__pyx_t_7) {
    } else {
      __pyx_t_6 = __pyx_t_7;
      goto __pyx_L7_bool_binop_done;
    }
    __pyx_t_7 = ((__pyx_v_niter <= __pyx_v_max_iter) != 0);
    __pyx_t_6 = __pyx_t_7;
    __pyx_L7_bool_binop_done:;
    if (!__pyx_t_6) break;

    /* "pypls/core/nipals.pyx":33
 *     while d > tol and niter <= max_iter:
 *         # w = X'u/u'u
 *         unorm = 0.             # <<<<<<<<<<<<<<
 *         for i in range(n):
 ...
 */
      __pyx_t_4 = __pyx_v_i;
      __pyx_v_uk = (*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_u.data) + __pyx_t_4)) )));

      /* "pypls/core/nipals.pyx":36
 *         for i in range(n):
 *             uk = u[i]
 *             unorm += uk * uk             # <<<<<<<<<<<<<<
 *             for j in range(p):
 *                 tmp_w[j] += uk * x[i, j]
 */
      __pyx_v_unorm = (__pyx_v_unorm + (__pyx_v_uk * __pyx_v_uk));

      /* "pypls/core/nipals.pyx":37
 *             uk = u[i]
 *             unorm += uk * uk
 *             for j in range(p):             # <<<<<<<<<<<<<<
 *                 tmp_w[j] += uk * x[i, j]
 ...
 */
        ...
        __pyx_t_4 = __pyx_v_i;
        __pyx_t_5 = __pyx_v_j;
        (__pyx_v_tmp_w[__pyx_t_11]) = ((__pyx_v_tmp_w[__pyx_t_11]) + (__pyx_v_uk * (*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_4 * __pyx_v_x.strides[0]) )) + __pyx_t_5)) )))));
      }
    }

    /* "pypls/core/nipals.pyx":40
 *                 tmp_w[j] += uk * x[i, j]
 * 
 *         wnorm = 0.             # <<<<<<<<<<<<<<
 *         for j in range(p):
 ...
 */
      __pyx_t_8 = __pyx_v_j;
      (__pyx_v_tmp_w[__pyx_t_8]) = ((__pyx_v_tmp_w[__pyx_t_8]) / __pyx_v_unorm);

      /* "pypls/core/nipals.pyx":43
 *         for j in range(p):
 *             tmp_w[j] /= unorm
 *             wnorm += tmp_w[j] * tmp_w[j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_v_wnorm = (__pyx_v_wnorm + ((__pyx_v_tmp_w[__pyx_v_j]) * (__pyx_v_tmp_w[__pyx_v_j])));
    }

    /* "pypls/core/nipals.pyx":46
 * 
 *         # normalize w: w = w / sqrt(w'w)
 *         wnorm = sqrt(wnorm)             # <<<<<<<<<<<<<<
 *         for j in range(p):
 *             w[j] = tmp_w[j] / wnorm
 */
    __pyx_v_wnorm = sqrt(__pyx_v_wnorm);

    /* "pypls/core/nipals.pyx":47
 *         # normalize w: w = w / sqrt(w'w)
 *         wnorm = sqrt(wnorm)
 *         for j in range(p):             # <<<<<<<<<<<<<<
 *             w[j] = tmp_w[j] / wnorm
 ...
 */
      __pyx_t_5 = __pyx_v_j;
      *((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_w.data) + __pyx_t_5)) )) = ((__pyx_v_tmp_w[__pyx_v_j]) / __pyx_v_wnorm);

      /* "pypls/core/nipals.pyx":49
 *         for j in range(p):
 *             w[j] = tmp_w[j] / wnorm
 *             tmp_w[j] = 0.             # <<<<<<<<<<<<<<
 * 
 ...
 */
      (__pyx_v_tmp_w[__pyx_v_j]) = 0.;
    }

    /* "pypls/core/nipals.pyx":52
 * 
 *         # calculate t, norm t, and c
 *         tnorm = 0.             # <<<<<<<<<<<<<<
 *         ck = 0.
 ...
 */
        ...
        __pyx_v_tk = (__pyx_v_tk + ((*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_5 * __pyx_v_x.strides[0]) )) + __pyx_t_4)) ))) * (*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_w.data) + __pyx_t_12)) )))));
      }

      /* "pypls/core/nipals.pyx":58
 *             for j in range(p):
 *                 tk += x[i, j] * w[j]
 *             t[i] = tk             # <<<<<<<<<<<<<<
 *             tnorm += tk * tk
 ...
 */
      ...
      *((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_t.data) + __pyx_t_12)) )) = __pyx_v_tk;

      /* "pypls/core/nipals.pyx":59
 *                 tk += x[i, j] * w[j]
 *             t[i] = tk
 *             tnorm += tk * tk             # <<<<<<<<<<<<<<
 *             ck += tk * y[i]
 *         c = ck / tnorm
 */
      __pyx_v_tnorm = (__pyx_v_tnorm + (__pyx_v_tk * __pyx_v_tk));

      /* "pypls/core/nipals.pyx":60
 *             t[i] = tk
 *             tnorm += tk * tk
 *             ck += tk * y[i]             # <<<<<<<<<<<<<<
 *         c = ck / tnorm
 ...
 */
      __pyx_t_12 = __pyx_v_i;
      __pyx_v_ck = (__pyx_v_ck + (__pyx_v_tk * (*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_y.data) + __pyx_t_12)) )))));
    }

    /* "pypls/core/nipals.pyx":61
 *             tnorm += tk * tk
 *             ck += tk * y[i]
 *         c = ck / tnorm             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_v_c = (__pyx_v_ck / __pyx_v_tnorm);

    /* "pypls/core/nipals.pyx":64
 * 
 *         # update u and calculate the tolerance
 *         d1 = 0.             # <<<<<<<<<<<<<<
 *         d2 = 0.
 ...
 *             uk = y[i] * ck
 */
    __pyx_v_ck = (__pyx_v_c / (__pyx_v_c * __pyx_v_c));

    /* "pypls/core/nipals.pyx":67
 *         d2 = 0.
 *         ck = c / (c * c)
 *         for i in range(n):             # <<<<<<<<<<<<<<
 *             uk = y[i] * ck
 ...
 */
      __pyx_t_12 = __pyx_v_i;
      __pyx_v_uk = ((*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_y.data) + __pyx_t_12)) ))) * __pyx_v_ck);

      /* "pypls/core/nipals.pyx":69
 *         for i in range(n):
 *             uk = y[i] * ck
 *             d1 += (uk - u[i]) ** 2             # <<<<<<<<<<<<<<
 *             d2 += uk * uk
 ...
 */
      __pyx_t_12 = __pyx_v_i;
      __pyx_v_d1 = (__pyx_v_d1 + pow((__pyx_v_uk - (*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_u.data) + __pyx_t_12)) )))), 2.0));

      /* "pypls/core/nipals.pyx":70
 *             uk = y[i] * ck
 *             d1 += (uk - u[i]) ** 2
 *             d2 += uk * uk             # <<<<<<<<<<<<<<
 *             u[i] = uk
 * 
 */
      __pyx_v_d2 = (__pyx_v_d2 + (__pyx_v_uk * __pyx_v_uk));

      /* "pypls/core/nipals.pyx":71
 *             d1 += (uk - u[i]) ** 2
 *             d2 += uk * uk
 *             u[i] = uk             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_12 = __pyx_v_i;
      *((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_u.data) + __pyx_t_12)) )) = __pyx_v_uk;
    }

    /* "pypls/core/nipals.pyx":73
 *             u[i] = uk
 * 
 *         d = sqrt(d1 / d2)             # <<<<<<<<<<<<<<
 *         niter += 1
 * 
 */
    __pyx_v_d = sqrt((__pyx_v_d1 / __pyx_v_d2));

    /* "pypls/core/nipals.pyx":74
 * 
 *         d = sqrt(d1 / d2)
 *         niter += 1             # <<<<<<<<<<<<<<
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_5pypls_4core_6nipals_1nipals(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_5pypls_4core_6nipals_nipals[] = "\n    Non-linear Iterative Partial Least Squares\n\n    Parameters\n    ----------\n    x: np.ndarray\n        Variable matrix with size n by p, where n number of samples,\n        p number of variables.\n    y: np.ndarray\n        Dependent variable with size n by 1.\n    tol: float\n        Tolerance for the convergence.\n    max_iter: int\n        Maximal number of iterations.\n\n    Returns\n    -------\n    w: np.ndarray\n        Weights with size p by 1.\n    c: float\n        Y-weight\n    t: np.ndarray\n        Scores with size n by 1\n\n    References\n    ----------\n    [1] Wold S, et al. PLS-regression: a basic tool of chemometrics.\n        Chemometr Intell Lab Sys 2001, 58, 109\342\200\223130.\n    [2] Bylesjo M, et al. Model Based Preprocessing and Background\n        Elimination: OSC, OPLS, and O2PLS. in Comprehensive Chemometrics.\n\n    ";
static PyMethodDef __pyx_mdef_5pypls_4core_6nipals_1nipals = {"nipals", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_5pypls_4core_6nipals_1nipals, METH_VARARGS|METH_KEYWORDS, __pyx_doc_5pypls_4core_6nipals_nipals};
static PyObject *__pyx_pw_5pypls_4core_6nipals_1nipals(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("nipals (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_x,&__pyx_n_s_y,&__pyx_n_s_tol,&__pyx_n_s_max_iter,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_y)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("nipals", 0, 2, 4, 1); __PYX_ERR(0, 81, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (kw_args > 0) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "nipals") < 0)) __PYX_ERR(0, 81, __pyx_L3_error)
      }
    } else {
    ...
    __pyx_v_x = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_x.memview)) __PYX_ERR(0, 81, __pyx_L3_error)
    __pyx_v_y = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_y.memview)) __PYX_ERR(0, 81, __pyx_L3_error)
    if (values[2]) {
      __pyx_v_tol = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_tol == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 81, __pyx_L3_error)
    } else {
      __pyx_v_tol = ((double)1e-10);
    }
    if (values[3]) {
      __pyx_v_max_iter = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_max_iter == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 81, __pyx_L3_error)
    } else {
  ...
  __Pyx_RaiseArgtupleInvalid("nipals", 0, 2, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 81, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("pypls.core.nipals.nipals", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_5pypls_4core_6nipals_nipals(__pyx_self, __pyx_v_x, __pyx_v_y, __pyx_v_tol, __pyx_v_max_iter);
...
static PyObject *__pyx_pf_5pypls_4core_6nipals_nipals(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, __Pyx_memviewslice __pyx_v_y, double __pyx_v_tol, int __pyx_v_max_iter) {
  Py_ssize_t __pyx_v_n;
  Py_ssize_t __pyx_v_p;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("nipals", 0);

  /* "pypls/core/nipals.pyx":115
 *     """
 *     cdef:
 *         Py_ssize_t n = x.shape[0]             # <<<<<<<<<<<<<<
 *         Py_ssize_t p = x.shape[1]
 ...
 */
  ...
  __pyx_t_1 = PyInt_FromSsize_t(__pyx_v_p); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 117, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_float64); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 117, __pyx_L1_error)
  ...
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_dc_double(__pyx_t_5, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 117, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_v_w = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "pypls/core/nipals.pyx":118
 *         Py_ssize_t p = x.shape[1]
 *         double[::1] w = np.zeros(p, dtype=np.float64)
 *         double[::1] t = np.zeros(n, dtype=np.float64)             # <<<<<<<<<<<<<<
 *         double[::1] u = np.zeros(n, dtype=np.float64)
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = PyInt_FromSsize_t(__pyx_v_n); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 118, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_float64); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 118, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_dc_double(__pyx_t_4, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 118, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_v_t = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "pypls/core/nipals.pyx":119
 *         double[::1] w = np.zeros(p, dtype=np.float64)
 *         double[::1] t = np.zeros(n, dtype=np.float64)
 *         double[::1] u = np.zeros(n, dtype=np.float64)             # <<<<<<<<<<<<<<
 *         double c
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_zeros); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 119, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = PyInt_FromSsize_t(__pyx_v_n); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 119, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  if (PyDict_SetItem(__pyx_t_4, __pyx_n_s_dtype, __pyx_t_2) < 0) __PYX_ERR(0, 119, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_5, __pyx_t_3, __pyx_t_4); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 119, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_dc_double(__pyx_t_2, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 119, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_v_u = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "pypls/core/nipals.pyx":122
 *         double c
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = __pyx_memoryview_fromslice(__pyx_v_w, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 124, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_5 = NULL;
  ...
  __Pyx_GetModuleGlobalName(__pyx_t_4, __pyx_n_s_np); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 124, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_asarray); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 124, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = __pyx_memoryview_fromslice(__pyx_v_t, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 124, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_1 = NULL;
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = PyFloat_FromDouble(__pyx_v_c); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 124, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "pypls.core.nipals.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "pypls.core.nipals.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "pypls.core.nipals.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "pypls.core.nipals._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_nipals(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_nipals},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_nipals, __pyx_k_nipals, sizeof(__pyx_k_nipals), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_pypls_core_nipals, __pyx_k_pypls_core_nipals, sizeof(__pyx_k_pypls_core_nipals), 0, 0, 1, 1},
  {&__pyx_kp_s_pypls_core_nipals_pyx, __pyx_k_pypls_core_nipals_pyx, sizeof(__pyx_k_pypls_core_nipals_pyx), 0, 0, 1, 0},
 ...
 *     Non-linear Iterative Partial Least Squares
 */
  __pyx_tuple__22 = PyTuple_Pack(10, __pyx_n_s_x, __pyx_n_s_y, __pyx_n_s_tol, __pyx_n_s_max_iter, __pyx_n_s_n, __pyx_n_s_p, __pyx_n_s_w, __pyx_n_s_t, __pyx_n_s_u, __pyx_n_s_c); if (unlikely(!__pyx_tuple__22)) __PYX_ERR(0, 81, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__22);
  __Pyx_GIVEREF(__pyx_tuple__22);
  __pyx_codeobj__23 = (PyObject*)__Pyx_PyCode_New(4, 0, 10, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__22, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_pypls_core_nipals_pyx, __pyx_n_s_nipals, 81, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__23)) __PYX_ERR(0, 81, __pyx_L1_error)
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("nipals_c", (void (*)(void))__pyx_f_5pypls_4core_6nipals_nipals_c, "double (__Pyx_memviewslice, __Pyx_memviewslice, double, int, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initnipals(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initnipals(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_nipals(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_nipals(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_nipals(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'nipals' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_nipals(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("nipals", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_pypls__core__nipals) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "pypls.core.nipals")) {
      if (unlikely(PyDict_SetItemString(modules, "pypls.core.nipals", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     Non-linear Iterative Partial Least Squares
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_5pypls_4core_6nipals_1nipals, NULL, __pyx_n_s_pypls_core_nipals); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 81, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_nipals, __pyx_t_1) < 0) __PYX_ERR(0, 81, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "pypls/core/nipals.pyx":1
 * cimport cython             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pypls.core.nipals", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pypls.core.nipals");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
