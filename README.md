...
An online trial version of the platform has been launched (http://47.115.46.121:5000/). The online trial version cannot save data for a long time and has limited computing resources, so local deployment is recommended.You can refer to the tutorial.pdf file for local deployment.
